  ...
  return (
    <section style={backgroundStyle} className="p-12 bg-[#F6F4EC] mt-20">
      <div className="flex flex-col gap-1 items-center mb-16">
        ...
        <p className='text-sm text-[#636363] text-center mt-5'>We believe that a company is only as strong as its people. Our team of skilled professionals work tirelessly to deliver excellence at every step.</p>
      </div>
          ...
          {teamMembers.map((member) => (
            ...
            >
              ...
              <div className="flex space-x-4 mt-4">
                <Link href={member.socials.facebook} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#44A05B]">
                  <FaFacebookF className="w-6 h-6" />
                </Link>
                <Link href={member.socials.instagram} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#44A05B]">
                  <FaInstagram className="w-6 h-6" />
                </Link>
                <Link href={member.socials.twitter} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#44A05B]">
